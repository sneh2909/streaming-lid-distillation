...
- The reported `algorithmic_latency_ms=435` is not evidence of a 435 ms decision. The README's missed switch and the backlog's teacher/policy transitions around 1.525/2.615 s illustrate the difference between architecture, evidence, and policy.
