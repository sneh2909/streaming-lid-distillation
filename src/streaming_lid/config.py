...
TARGET_AUDIT_MIN_TEACHER_NATIVE_CORRECT_PER_LANGUAGE = 8
TARGET_AUDIT_MIN_CLIP_MEAN_RETAINED_MASS = 0.50
TARGET_AUDIT_MIN_CLIP_MEAN_MANIFEST_PROBABILITY_T1 = 0.50
